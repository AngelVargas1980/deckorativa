            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="page-subtitle">
                        ...
                        Agrega un nuevo elemento a tu catálogo
                    </p>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" 
                                   ...
                                   placeholder="Ej: Diseño de Sala Premium" required>
                            @error('nombre')
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" rows="4" 
                                      ...
                                      placeholder="Describe el servicio o producto...">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="precio" value="{{ old('precio') }}" step="0.01" min="0"
                                           class="form-input pl-8 @error('precio') border-red-500 @enderror" 
                            ...
                            <div>
                                ...
                                <select name="unidad_medida" class="form-select @error('unidad_medida') border-red-500 @enderror" required>
                                    ...
                                    <option value="metro2" {{ old('unidad_medida') == 'metro2' ? 'selected' : '' }}>Metro²</option>
                                    <option value="hora" {{ old('unidad_medida') == 'hora' ? 'selected' : '' }}>Hora</option>
                                    <option value="evento" {{ old('unidad_medida') == 'evento' ? 'selected' : '' }}>Evento</option>
                                </select>
                                @error('unidad_medida')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="tiempo_estimado" value="{{ old('tiempo_estimado') }}" min="1"
