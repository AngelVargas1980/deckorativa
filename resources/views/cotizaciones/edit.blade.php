...
@section('content')
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="card">
                            ...
                            <div class="text-center py-8 text-gray-500" id="no-servicios" style="display:none;">
    ...
    <script>
        ...
        // Cargar servicios existentes de la cotización
        @foreach($cotizacion->detalles as $detalle)
            contadorServicios++;
            serviciosSeleccionados.push({
                id: contadorServicios,
                servicio_id: {{ $detalle->servicio_id }},
                servicio: @json($detalle->servicio),
        ...
        // Renderizar servicios existentes al cargar la página
        renderizarServicios();
        calcularTotales();
                ...
                html += `
                    <div class="border border-gray-200 rounded-lg p-4 mb-4 relative" data-item-id="${item.id}">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="servicios[${index}][notas]" value="${item.notas || ''}" class="form-input" placeholder="Notas adicionales...">
                        </div>
                    </div>
                `;
            });
